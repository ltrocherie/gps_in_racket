...
(define (aff_graph argue)
  (response/xexpr (create_html_responses "BEST ROUTE" "800" "800" data argue (roam-bounds t) "blue" "red")
))


;affiche la map vide
(define (aff_blank_graph)
  (response/xexpr (create_html_response "OPEN MAPPING SERVICE" "800" "800" data (roam-bounds t) "blue"))
)
